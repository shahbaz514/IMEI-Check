            ...
            <div class="bg-light text-center rounded col-sm-12 p-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-4">
                            <select class="form-select form-select-sm mb-3" name="group" required aria-label=".form-select-sm example">
                ...
                if (isset($_POST['signup']))
                {
                    ...
                    {
                        $sqlInsert = mysqli_query($db, "INSERT INTO `users`(`name`, `email`, `username`, `password`, `role`, `group`, `status`) VALUES ('$name', '$email', '$username', '$password', 'Author', '$group','Active')");
                        if ($sqlInsert)
                        {
                            if ($role == 'Admin')
                            {
