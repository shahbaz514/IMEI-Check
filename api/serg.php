...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && $_GET['endpoint'] == 'servicesget') {
...
$stmk = $db->query('SELECT * FROM categories ORDER BY position ASC');
$stmt = $db->query('SELECT * FROM services ORDER BY position ASC');
